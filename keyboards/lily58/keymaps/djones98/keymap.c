...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                      KC_LALT, KC_LGUI,  LOWER, KC_SPC,     SC_SENT,   KC_BSPC,  RAISE, KC_RGUI
),
...
[_RAISE] = LAYOUT(
  ...
  _______, _______, _______, KC_INSERT, KC_HOME, KC_PGUP,                     KC_LEFT, KC_UP, KC_DOWN, KC_RIGHT, _______, _______,
