 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                      KC_LALT, KC_LGUI,  LOWER, KC_SPC,     SC_SENT,   KC_BSPC,  KC_RGUI, RAISE
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 ...
 */
[_LOWER] = LAYOUT(
  KC_GRAVE, _______, _______, _______, _______, _______,                                        _______, _______, _______,_______, _______, KC_DELETE,
  _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                                         KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, LSFT(KC_MINUS),
  _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_VOLU,                                        KC_6,    KC_7,    KC_8,    KC_9,    LSFT(KC_NUBS), KC_NUHS,
  _______, _______, _______, KC_MPLY, KC_MNXT, KC_VOLD, LSFT(KC_LBRC),  LSFT(KC_RBRC),  _______, _______, _______, _______, KC_NUBS, _______,
...
[_RAISE] = LAYOUT(
  ...
  _______, _______, _______, KC_INSERT, KC_HOME, KC_PGUP,                     _______, _______, _______, _______, _______, _______,
