...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, MO(2), KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH,
		KC_LCTL, KC_LGUI, KC_LALT, LT(1,KC_SPACE), KC_BSPC, ARROW_KEYS, KC_BTN1, KC_BTN2, KC_RSFT,KC_DEL),
	...
	LAYOUT(
		...
		KC_TRNS, KC_NUHS, KC_NUBS, LSFT(KC_NUHS), LSFT(KC_NUBS), KC_UNDS, KC_TRNS, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, KC_PLUS,
